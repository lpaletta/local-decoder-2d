...
def SIGNAL2D(physics, decoder, simulation):
    ...
    for t in range(T):
        ...
        if record_var == "View": #Matching neighboring defects - a
        ...
        if record_var == "View": #Emission of anti-signals - b
            # Append configuration
            configuration = defect_array, forward_signal_1_array, forward_signal_2_array, anti_signal_1_array, anti_signal_2_array,stack_1_array, stack_2_array
            configuration_history.append(configuration)
        ...
        for _ in range(anti_signal_velocity):
            ...
            if record_var == "View": #Propagation of anti-signals and recombination - c
                # Append configuration
                configuration = defect_array, forward_signal_1_array, forward_signal_2_array, anti_signal_1_array, anti_signal_2_array,stack_1_array, stack_2_array
                configuration_history.append(configuration)
                step_history.append((t,2))
        ...
        if record_var == "View": #Creation and propagation of 1-forward-signals - d
            # Append configuration
            configuration = defect_array, forward_signal_1_array, forward_signal_2_array, anti_signal_1_array, anti_signal_2_array,stack_1_array, stack_2_array
            configuration_history.append(configuration)
            step_history.append((t,3))
        ...
        if record_var == "View": #Creation and propagation of 2-forward-signals - e
            # Append configuration
            configuration = defect_array, forward_signal_1_array, forward_signal_2_array, anti_signal_1_array, anti_signal_2_array,stack_1_array, stack_2_array
            configuration_history.append(configuration)
            step_history.append((t,4))
        ...
        if record_var == "View": #Creation and propagation of 1-forward-signals - f
            # Append configuration
            configuration = defect_array, forward_signal_1_array, forward_signal_2_array, anti_signal_1_array, anti_signal_2_array,stack_1_array, stack_2_array
            configuration_history.append(configuration)
            step_history.append((t,5))
