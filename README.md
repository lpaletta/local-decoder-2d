...
3. [threshold] Analysis of the threshold - (Main text) & Fig.4 (c)
4. [poisson] Verification that the logical failure behavior is Markovian Fig - (EM) Fig.5 (a)
5. [visualization] Space-time representation of the automaton - (Main text) Fig.3 (b)
